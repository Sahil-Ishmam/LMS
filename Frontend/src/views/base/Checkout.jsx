...
const courses = [
  {
    ...
    price: 350,
    imgUrl: "https://eduport.webestica.com/assets/images/courses/4by3/07.jpg",
  },
  {
    name: "Building Scalable APIs with GraphQL",
    price: 350,
                          ...
                          <td>
                            <div className="d-lg-flex align-items-center">
                              ...
                              <h6 className="mb-0 ms-lg-3 mt-2 mt-lg-0">
                                <Link to="#" className='text-decoration-none text-dark'>{course.name}</Link>
                              </h6>
                            </div>
                          </td>
              ...
              <div className="row mb-0">
                <div className="col-md-6 col-xl-12">
                  <div className="shadow p-4 mb-4 rounded-3">
                    ...
                    {/* Course Item */}
                    {courses.map((course, index) => (
                      <div className="row g-2 shadow p-2 mb-4 rounded-3" key={index}>
                    ...
                    <div className="p-3 shadow rounded-3 mt-3">
                      ...
                      <div className="d-grid">
                        <button className="btn btn-lg btn-success mt-2"> Pay With PayPal</button>
                        <button className="btn btn-lg btn-success mt-2"> Pay With Stripe</button>
                      </div>
