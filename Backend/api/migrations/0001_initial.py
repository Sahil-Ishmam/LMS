# Generated by Django 5.2.4 on 2025-07-24 03:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='default.jpg', null=True, upload_to='course-file')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_status', models.CharField(choices=[('Paid', 'Paid'), ('Processing', 'Processing'), ('Failed', 'Failed')], default='Processing', max_length=40)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(choices=[('English', 'English'), ('Bangla', 'Bangla'), ('French', 'French'), ('Spanish', 'Spanish')], default='English', max_length=100)),
                ...
                ('platform_status', models.CharField(choices=[('Review', 'Review'), ('Draft', 'Draft'), ('Disabled', 'Disabled'), ('Published', 'Published'), ('Rejected', 'Rejected')], default='Published', max_length=40)),
                ('teacher_status', models.CharField(choices=[('Draft', 'Draft'), ('Disabled', 'Disabled'), ('Published', 'Published')], default='Published', max_length=40)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('oid', shortuuid.django_fields.ShortUUIDField(alphabet='1234567890', length=6, max_length=20, prefix='', unique=True)),
                ('date', models.DateTimeField(default=django.utils.timezone.now)),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_item', to='api.cartorder')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_duration', models.CharField(blank=True, max_length=500, null=True)),
                ('preview', models.BooleanField(default=False)),
                ('variant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='variant_item', to='api.variant')),
            ],
        ),
        migrations.CreateModel(
